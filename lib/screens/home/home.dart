...
import 'package:recipe_app/screens/recipe_tile/recipe_tile.dart';
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                //  recipies = new List();
                                // String url =
                                //     "https://api.edamam.com/search?q=${textEditingController.text}&app_id=$appId&app_key=$applicationKey";
                                ...
                                // });
                                 recipies=await httpService.getReceipe(textEditingController.text);
                                setState(() {
                                  _loading = false;
                                });
